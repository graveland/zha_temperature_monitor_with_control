...
def create_zigbee_ota_file(input_bin, output_ota, file_version=DEFAULT_FILE_VERSION):
    ...
    header = zigpy.ota.image.OTAImageHeader(
        ...
        header_string="ESP32-H2 Temp Monitor",
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python3 create_ota_image.py build/zha_temperature_monitor.bin")
        print("  python3 create_ota_image.py build/zha_temperature_monitor.bin output.ota 2")
        sys.exit(1)
